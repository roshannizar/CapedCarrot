...
<div class="sidenav" id="sidenavi" onmouseover="openNav()" onmouseout="closeNav()">
    ...
    <a href="CC Online Curry.php"><button class="btn1" style="border-left: 4px solid teal;padding-left:100px;background-image:url(CSS/Icons/curry.png);background-size: 50px;background-repeat: no-repeat">Curry</button></a>
...
<nav class="navitop" id="topnavi">
    ...
    <a href="curryDestroy.php" class="linker"><b>
            <?php
            session_start();
            $check=$_SESSION["loginuser"];
            if($check=="" || $check==null)
...
<div class="main" id="main" onmouseover="closebtn()">
    ...
    <br/><br/>
    <div>
        <label style="font-size:28px;font-family:calibri;margin-left:60px">Curry</label>
            ...
            <div class=" fade" style="margin-left:50px;margin-top:30px">
                ...
                while($row=mysql_fetch_array($stock))
                {
                    ...
                    <table cellspacing="10"style="width:100%;">
                        ...
                        <tr>
                            <td>
                                <form method="POST" action="CC%20Online%20Package.php">
        ...
        <div class="container">
            ...
            <div style="margin-right:10px;margin-left:10px;margin-top:10px;padding-top:20px">
                <div style="margin-top:80px">
                    <div style="width:100%;">
                        <center>
                            <form method="post" action="CC%20Online%20Curry.php">
                        ...
                        <div align="center" id="searchi">
                            <table class="searchtable">
                                ...
                                $selectString="SELECT * FROM stock WHERE categoryname='Curry' AND stockname like '%$searchpack%'";
