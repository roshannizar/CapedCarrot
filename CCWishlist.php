...
<div class="main" id="main" onmouseover="closebtn()">
    ...
    <div>
        <div class="maincontainer">
            <label style="font-size:28px;margin-left:50px;font-family:calibri;font-weight:bold;background-color:white">Wishlist</label><br/>
            <center>
                <label>Total Price:</label>
                <label><?php echo $row["cquantity"]*$row["price"]; ?></label>
            </center>
