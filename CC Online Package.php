...
<nav class="navitop" id="topnavi">
    ...
    <a href="packageDestroy.php" class="linker"><b>
            <?php
            session_start();
            $check=$_SESSION["loginuser"];
            if($check=="" || $check==null)
...
<div class="main" id="main" onmouseover="closebtn()">
    ...
    <br/><br/>
    <div>
        <label style="font-size:28px;font-family:calibri;margin-left:60px">Packages</label>
                    ...
                    <div style="width:100%;">
                        ...
                        <div align="center" id="searchi">
                            <table class="searchtable">
                                ...
                                $selectString="SELECT * FROM stock WHERE categoryname='Package' AND stockname like '%$searchpack%'";
