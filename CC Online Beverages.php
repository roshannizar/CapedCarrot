...
<div class="sidenav" id="sidenavi" onmouseover="openNav()" onmouseout="closeNav()">
    ...
    <a href="CC%20Online%20Beverages.php"><button class="btn1" style="border-left: 4px solid teal;padding-left:100px;background-image:url(CSS/Icons/beverages.png);background-size: 50px;background-repeat: no-repeat">Beverages</button></a>
...
<nav class="navitop" id="topnavi">
    ...
    <a href="beverageDestroy.php" class="linker"><b>
            <?php
            session_start();
            $check=$_SESSION["loginuser"];
            if($check=="" || $check==null)
...
<div class="main" id="main" onmouseover="closebtn()">
    ...
    <br/><br/>
    <div>
        <label style="font-size:28px;font-family:calibri;margin-left:60px">Beverages</label>
            ...
            <div class=" fade" style="margin-left:50px;margin-top:30px">
                ...
                while($row=mysql_fetch_array($stock))
                {
                    ...
                    <table cellspacing="10"style="width:100%;">
                        ...
                        <tr>
                            <td>
                                <form method="POST" action="CC%20Online%20Beverages.php">
                    ...
                    <div style="width:100%;">
                        ...
                        <div align="center" id="searchi">
                            <table class="searchtable">
                                ...
                                $selectString="SELECT * FROM stock WHERE categoryname='Beverages' AND stockname like '%$searchpack%'";
